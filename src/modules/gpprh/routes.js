...
router.get('/job-contracts', authMiddleware, GrppController.jobContracts);
...
router.get('/job-application', authMiddleware, canAll(['CANDIDATE']), GrppController.viewJobApplication);
...
router.get('/job/:codeCandidate', authMiddleware, GrppController.viewJob);
