 ...
 * log de status.
 *
 * @module modules/global/infrastructure/miepp/mysql-miepp-player.repository
 */

const { MieppPlayerRepositoryPort } = require('../../application/miepp/ports/miepp-player-repository.port');
...
} = require('../../repositories/mysql/miepp-player.queries');

class MysqlMieppPlayerRepository extends MieppPlayerRepositoryPort {
    /**
     * @param {object} [deps]
     ...
     *   padrão vem do `config/miepp`.
     */
    constructor({ offlineAfterMinutes = mieppConfig.offlineAfterMinutes } = {}) {
        super();
...
module.exports = { MysqlMieppPlayerRepository };
