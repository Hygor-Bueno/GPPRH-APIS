/**
 * @fileoverview Ponto único de integração do meipp com o sistema de arquivos
 ...
 *
 * @module modules/global/infrastructure/meipp/meipp-media-storage.service
 */
 ...
 */
const STORAGE_MODULE = 'MEIPP';

class MeippMediaStorageService {
    /**
     * Grava o arquivo enviado e devolve os metadados que `meipp_media` guarda.
     *
     * O `_files` deduplica por SHA-256: enviar de novo o mesmo arquivo devolve
     * o registro existente sem gravar nada em disco. Duas mídias do meipp
     ...
     *
     * @param {number|string} fileId - `meipp_media.file_id`.
...
module.exports = { MeippMediaStorageService, STORAGE_MODULE };
