/**
 * @fileoverview Adapter MySQL de `meipp_playlists` e `meipp_playlist_items`.
 *
 * @module modules/global/infrastructure/meipp/mysql-meipp-playlist.repository
 */

const { MeippPlaylistRepositoryPort } = require('../../application/meipp/ports/meipp-playlist-repository.port');
const { query, execute, count, transaction } = require('./meipp-mysql.helper');
const {
    SQL_LIST_PLAYLISTS,
    SQL_COUNT_PLAYLISTS,
...
} = require('../../repositories/mysql/meipp-playlist.queries');

class MysqlMeippPlaylistRepository extends MeippPlaylistRepositoryPort {
...
module.exports = { MysqlMeippPlaylistRepository };
