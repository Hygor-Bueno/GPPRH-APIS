/**
 * @fileoverview Adapter MySQL de `meipp_schedules` e `meipp_schedule_targets`.
 *
 * @module modules/global/infrastructure/meipp/mysql-meipp-schedule.repository
 */

const { MeippScheduleRepositoryPort } = require('../../application/meipp/ports/meipp-schedule-repository.port');
const { TargetType } = require('../../domain/meipp/meipp.enums');
...
const {
    ...
    SQL_PLAYER_EXISTS,
    SQL_GROUP_EXISTS,
} = require('../../repositories/mysql/meipp-schedule.queries');
...
class MysqlMeippScheduleRepository extends MeippScheduleRepositoryPort {
...
module.exports = { MysqlMeippScheduleRepository, groupTargetsByScheduleId };
