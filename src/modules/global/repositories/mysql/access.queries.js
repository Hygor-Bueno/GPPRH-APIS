...
const PATCH_USER_FIELDS = {
    ...
    ad_status:     'string',
    password:      'password'   // tipo especial: exige hash bcrypt no use-case
};
...
/** Retorna um usuário pelo ID com seus papéis e permissões expandidos. Parâmetros: [id] */
...
/** Desativa um usuário (soft-delete: ad_status = 'delete'). Parâmetros: [updated_by, id] */
