...
INSERT IGNORE INTO `_permissions` (code, description) VALUES
    ...
    ('EPP_ECOMMERCE', 'Módulo EPP — acesso ao fluxo de confirmação de pedidos e-commerce (Consinco)');
...
--  EPP_ECOMMERCE  → Fluxo de confirmação de pedidos e-commerce (Consinco)
-- ─────────────────────────────────────────────────────────────────────────────
...
--   AND p.code IN ('USE_EPP', 'EPP_ORDERS', 'EPP_PRODUCTS', 'EPP_RECEIPE', 'EPP_MANAGE', 'EPP_ECOMMERCE');
...
--  e nunca teve 'EPP_ECOMMERCE'). Execute manualmente em produção:
-- ============================================================
--
