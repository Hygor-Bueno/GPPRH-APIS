 ...
 *
 * @module modules/global/repositories/mysql/gapp-expenses.queries
 */
...
function buildInsertSinisterParams(data, expenId) {
    return [
        ...
        data.damage_type_id_fk ?? null,
        expenId,
        data.id_insurance_fk ?? null
    ];
}
