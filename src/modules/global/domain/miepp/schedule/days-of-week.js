/**
 * @fileoverview Bitmask de dias da semana de `miepp_schedules.days_of_week`.
 *
 ...
 *
 * @module modules/global/domain/miepp/schedule/days-of-week
 */
 ...
 *
 * @param {number} mask     - `miepp_schedules.days_of_week` (0–127).
