/**
 * @fileoverview Espelho dos ENUMs do schema `miepp_*` (MySQL `global`).
 *
 * Todo valor aqui É o texto gravado na coluna — a validação de payload
 * (`schemas/miepp.schema.js`) usa estas listas para rejeitar enum inválido
 ...
 *
 * @module modules/global/domain/miepp/miepp.enums
 */

/** `miepp_locations.type` */
...
/** `miepp_players.orientation` */
const Orientation = Object.freeze({
    LANDSCAPE: 'landscape',
    PORTRAIT:  'portrait',
});

/** `miepp_players.status` */
...
/** `miepp_playlist_items.transition` */
...
/** `miepp_schedule_targets.target_type` */
...
/** `miepp_device_commands.command_type` */
...
/** `miepp_player_status_log.event_type` */
