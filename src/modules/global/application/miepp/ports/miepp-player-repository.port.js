 ...
 *
 * @module modules/global/application/miepp/ports/miepp-player-repository.port
 */

class MieppPlayerRepositoryPort {
    // ─── Players ────────────────────────────────────────────────────────────
     ...
     * em `miepp_player_status_log`, na mesma transação.
     * @param {number} playerId
...
module.exports = { MieppPlayerRepositoryPort };
