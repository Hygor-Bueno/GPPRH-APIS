 ...
 * prefixo da suite.
 *
 * @module modules/global/application/miepp/ports/miepp-schedule-repository.port
 */

class MieppScheduleRepositoryPort {
    ...
    /**
     * `miepp_schedule_targets.target_id` é polimórfico e não tem FK — a
...
module.exports = { MieppScheduleRepositoryPort };
