/**
 * @fileoverview Casos de uso de locais (`meipp_locations`).
 *
 * @module modules/global/application/meipp/location/meipp-location.use-cases
 */

const { AppError } = require('../../../../../errors/app.error');
const { normalizePagination, optionalFlag, paginated } = require('../../../domain/meipp/pagination.rules');

class MeippLocationUseCases {
    /**
     * @param {object} deps
...
module.exports = { MeippLocationUseCases };
