 ...
 * suite.
 *
 * @module modules/global/application/meipp/ports/meipp-playlist-repository.port
 */

class MeippPlaylistRepositoryPort {
...
module.exports = { MeippPlaylistRepositoryPort };
