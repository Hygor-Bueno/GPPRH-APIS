 ...
 *
 * @module modules/global/application/meipp/playlist/meipp-playlist.use-cases
 */

const { AppError } = require('../../../../../errors/app.error');
const { normalizePagination, optionalFlag, paginated } = require('../../../domain/meipp/pagination.rules');

class MeippPlaylistUseCases {
    /**
     * @param {object} deps
     * @param {import('../ports/meipp-playlist-repository.port').MeippPlaylistRepositoryPort} deps.repository
     ...
     *
     * `fk_meipp_schedules_playlist` é ON DELETE CASCADE: apagar a playlist
...
module.exports = { MeippPlaylistUseCases };
