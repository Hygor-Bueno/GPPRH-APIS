 ...
 * `domain/meipp/schedule/schedule-resolver.rules`, chamada pela sub-feature
 * `device`. Este módulo só cuida do cadastro.
 *
 * @module modules/global/application/meipp/schedule/meipp-schedule.use-cases
 */

const { AppError } = require('../../../../../errors/app.error');
const { TargetType } = require('../../../domain/meipp/meipp.enums');
const { ALL_DAYS } = require('../../../domain/meipp/schedule/days-of-week');
const { normalizePagination, optionalFlag, paginated } = require('../../../domain/meipp/pagination.rules');

class MeippScheduleUseCases {
    /**
     * @param {object} deps
     * @param {import('../ports/meipp-schedule-repository.port').MeippScheduleRepositoryPort} deps.repository
    ...
    async create(payload, meippUser) {
...
module.exports = { MeippScheduleUseCases };
