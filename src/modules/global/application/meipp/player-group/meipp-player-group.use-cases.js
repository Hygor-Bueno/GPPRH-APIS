/**
 * @fileoverview Casos de uso de grupos de players (`meipp_player_groups`).
 *
 * @module modules/global/application/meipp/player-group/meipp-player-group.use-cases
 */

const { AppError } = require('../../../../../errors/app.error');
const { normalizePagination, paginated } = require('../../../domain/meipp/pagination.rules');

class MeippPlayerGroupUseCases {
    /**
     * @param {object} deps
    ...
    /**
     * Remove o grupo. Os vínculos em `meipp_player_group_members` caem por
...
module.exports = { MeippPlayerGroupUseCases };
